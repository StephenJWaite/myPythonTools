...
workingDir = '/home/stephen/Documents/PhD/Data/ContractionContours/Grouped/'
workingDirOF = '/home/stephen/OpenFOAM/Simulations2/ParallelSplineCheck3/'
...
maxit = 20
sobd = [4,4,4]
sobw = 1e-10 #0.000001#for quad444, 0.000005 is a good start, then crank
xtol = 1e-12
...
for timePoint in range(0,10):#range(cMshape[0]):
